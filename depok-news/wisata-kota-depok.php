...
<body>
    ...
    <ul class="nav justify-content-center bg-dark">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="wisata-kota-depok.php">Wisata</a>
      </li>
      <li class="nav-item">
    ...
    <div class="row">       
        <div class="main">
            ...
            $query = "SELECT * FROM berita WHERE status = 'aktif' AND id_kategori = 3 ORDER BY tanggal DESC";
            $sql = mysqli_query($conn, $query);
            while ($data = mysqli_fetch_array($sql)) {                            
            ?>
                <h2><u><?= $data['judul'] ?></u></h2>
                <h5>Dipublish pada, <?= $data['tanggal'] ?></h5>
